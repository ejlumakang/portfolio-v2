  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-24 md:pt-16 pb-12 md:pb-0 relative overflow-hidden">
      ...
      <div className="max-w-6xl w-full mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] aspect-square md:aspect-[4/5] relative rounded-2xl overflow-hidden shadow-xl group">
            
            {/* Gradient tracing effect */}
            <motion.div 
              animate={{ rotate: 360 }}
              transition={{ repeat: Infinity, duration: 6, ease: "linear" }}
              className="absolute inset-[-100%] w-[300%] h-[300%] bg-[conic-gradient(from_0deg,transparent_75%,rgba(0,0,0,0.4)_100%)] dark:bg-[conic-gradient(from_0deg,transparent_75%,rgba(255,255,255,0.3)_100%)] origin-center"
            />

            <div className="absolute inset-[1.5px] rounded-[calc(1rem-1.5px)] overflow-hidden bg-card z-10 border border-border/40">
              <img 
                src="/img/profile.JPG" 
                alt="Eloiza Lumakang" 
        ...
        >
          ...
          >
            <a href="mailto:ejlumakang@gmail.com" className="hover:text-foreground transition-transform hover:-translate-y-0.5 duration-200"><Mail className="w-5 h-5" /></a>
            <a href="https://www.linkedin.com/in/ejlmkng/" target="_blank" className="hover:text-foreground transition-transform hover:-translate-y-0.5 duration-200"><FaLinkedin size={20} /></a>
            <a href="https://github.com/ejlumakang" target="_blank" className="hover:text-foreground transition-transform hover:-translate-y-0.5 duration-200"><FaGithub size={20} /></a>
          </motion.div>
        </motion.div>
